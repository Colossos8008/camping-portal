...
const CURATED_PRESET_DATA: Record<CuratedPresetKey, CuratedHighlightRow[]> = {
  "nievern-highlights": [
    { key: "deutsches-eck", name: "Deutsches Eck", lat: 50.36779, lng: 7.60668, category: "landmark", region: "koblenz", country: "Germany", description: "Berühmte Landmarke an der Landzunge am Zusammenfluss von Rhein und Mosel mit Kaiser-Wilhelm-Nationaldenkmal und großem Aussichtspunkt.", tags: ["rivers-confluence", "landmark", "national-monument", "major-viewpoint", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Deutsches_Eck%2C_Koblenz.jpg" },
    { key: "festung-ehrenbreitstein", name: "Festung Ehrenbreitstein", lat: 50.36558, lng: 7.61379, category: "fortress", region: "koblenz", country: "Germany", description: "Große preußische Hauptfestung über Rhein und Mosel, ikonische Landmarke mit Festungsarchitektur und Panoramablick.", tags: ["fortress", "major-fortress", "landmark", "iconic", "major-attraction", "unesco-context"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Festung_Ehrenbreitstein.jpg" },
    ...
    { key: "schloss-sayn", name: "Schloss Sayn", lat: 50.43699, lng: 7.57656, category: "palace", region: "bendorf", country: "Germany", description: "Neugotisches Schloss der Fürsten zu Sayn-Wittgenstein-Sayn.", tags: ["palace", "neo-gothic", "bendorf"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Schloss_Sayn.jpg" },
    ...
    { key: "garten-der-schmetterlinge-sayn", name: "Garten der Schmetterlinge Schloss Sayn", lat: 50.43655, lng: 7.57752, category: "park", region: "bendorf", country: "Germany", description: "Bekannte Schmetterlingshalle und Parkanlage im Schlosspark Sayn.", tags: ["park", "family-highlight", "sayn"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Garten_der_Schmetterlinge%2C_Sayn.jpg" },
