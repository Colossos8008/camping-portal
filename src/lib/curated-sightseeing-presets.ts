...
const CURATED_PRESET_DATA: Record<CuratedPresetKey, CuratedHighlightRow[]> = {
  "nievern-highlights": [
    { key: "deutsches-eck", name: "Deutsches Eck", lat: 50.36725, lng: 7.60659, category: "landmark", region: "koblenz", country: "Germany", description: "Berühmte Landmarke an der Landzunge am Zusammenfluss von Rhein und Mosel mit Kaiser-Wilhelm-Nationaldenkmal und großem Aussichtspunkt.", tags: ["rivers-confluence", "landmark", "national-monument", "major-viewpoint", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Deutsches_Eck%2C_Koblenz.jpg" },
    ...
    { key: "kurfuerstliches-schloss-koblenz", name: "Kurfürstliches Schloss Koblenz", lat: 50.35173, lng: 7.60028, category: "palace", region: "koblenz", country: "Germany", description: "Klassizistisches Schloss am Rhein mit bedeutender Stadtbildwirkung.", tags: ["palace", "historic", "rhine"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Kurf%C3%BCrstliches_Schloss_Koblenz_2014.jpg" },
    { key: "marksburg", name: "Marksburg", lat: 50.27456, lng: 7.64192, category: "castle", region: "braubach", country: "Germany", description: "Ikonische mittelalterliche Höhenburg am Mittelrhein, als nahezu vollständig erhaltene Burganlage ein Hauptziel der Region.", tags: ["castle", "medieval-castle", "iconic-castle", "landmark", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Marksburg.jpg" },
    ...
    { key: "burg-lahneck", name: "Burg Lahneck", lat: 50.31179, lng: 7.61822, category: "castle", region: "lahnstein", country: "Germany", description: "Mittelalterliche Burganlage oberhalb der Lahnmündung mit markantem Landmarken-Charakter.", tags: ["castle", "medieval-castle", "landmark", "major-viewpoint", "rhine"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Burg_Lahneck.jpg" },
    ...
    { key: "liebfrauenkirche-koblenz", name: "Liebfrauenkirche Koblenz", lat: 50.35935, lng: 7.59529, category: "church", region: "koblenz", country: "Germany", description: "Prägende Pfarrkirche in der Koblenzer Altstadt mit Zwiebeltürmen.", tags: ["church", "old-town", "landmark"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Liebfrauenkirche%2C_Koblenz.jpg" },
