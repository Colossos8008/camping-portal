...
const CURATED_PRESET_DATA: Record<CuratedPresetKey, CuratedHighlightRow[]> = {
  "nievern-highlights": [
    { key: "deutsches-eck", name: "Deutsches Eck", lat: 50.3656, lng: 7.6053, category: "landmark", region: "koblenz", country: "Germany", description: "Berühmte Landmarke an der Landzunge am Zusammenfluss von Rhein und Mosel mit Kaiser-Wilhelm-Nationaldenkmal und großem Aussichtspunkt.", tags: ["rivers-confluence", "landmark", "national-monument", "major-viewpoint", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Deutsches%20Eck%20Koblenz%20abends.jpg" },
    { key: "festung-ehrenbreitstein", name: "Festung Ehrenbreitstein", lat: 50.3658, lng: 7.6132, category: "fortress", region: "koblenz", country: "Germany", description: "Große preußische Hauptfestung über Rhein und Mosel, ikonische Landmarke mit Festungsarchitektur und Panoramablick.", tags: ["fortress", "major-fortress", "landmark", "iconic", "major-attraction", "unesco-context"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Festung%20Ehrenbreitstein%20Koblenz.jpg" },
    ...
    { key: "marksburg", name: "Marksburg", lat: 50.2749, lng: 7.6416, category: "castle", region: "braubach", country: "Germany", description: "Ikonische mittelalterliche Höhenburg am Mittelrhein, als nahezu vollständig erhaltene Burganlage ein Hauptziel der Region.", tags: ["castle", "medieval-castle", "iconic-castle", "landmark", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Marksburg%20Braubach.jpg" },
    { key: "abtei-maria-laach", name: "Abtei Maria Laach", lat: 50.4160, lng: 7.2752, category: "abbey", region: "maria-laach", country: "Germany", description: "Bedeutende romanische Benediktinerabtei mit Basilika und Klostertradition am Laacher See.", tags: ["abbey", "monastery", "basilica", "pilgrimage", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Abtei%20Maria%20Laach%20Westfassade.jpg" },
    { key: "burg-lahneck", name: "Burg Lahneck", lat: 50.3040, lng: 7.6188, category: "castle", region: "lahnstein", country: "Germany", description: "Mittelalterliche Burganlage oberhalb der Lahnmündung mit markantem Landmarken-Charakter.", tags: ["castle", "medieval-castle", "landmark", "major-viewpoint", "rhine"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Burg%20Lahneck%20Lahnstein.jpg" },
    { key: "schloss-sayn", name: "Schloss Sayn", lat: 50.4370, lng: 7.5765, category: "palace", region: "bendorf", country: "Germany", description: "Neugotisches Schloss der Fürsten zu Sayn-Wittgenstein-Sayn.", tags: ["palace", "neo-gothic", "bendorf"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Schloss%20Sayn.jpg" },
    ...
    { key: "burg-eltz", name: "Burg Eltz", lat: 50.2054, lng: 7.3365, category: "castle", region: "wierschem", country: "Germany", description: "International ikonische mittelalterliche Burg (Burg Eltz) im Elzbachtal, eines der bekanntesten Hauptziele der Region.", tags: ["castle", "medieval-castle", "iconic-castle", "landmark", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Burg%20Eltz%20Wierschem.jpg" },
  ],
};
