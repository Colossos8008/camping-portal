...
INSERT INTO "new_Place" ("createdAt", "dogAllowed", "gastronomy", "id", "lat", "lng", "name", "onlineBooking", "rating", "sanitary", "type", "updatedAt", "yearRound") SELECT "createdAt", "dogAllowed", "gastronomy", "id", "lat", "lng", "name", "onlineBooking", "rating", "sanitary", "type", "updatedAt", "yearRound" FROM "Place";
DROP TABLE "Place";
