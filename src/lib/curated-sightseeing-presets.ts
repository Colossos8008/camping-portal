...
const CURATED_PRESET_DATA: Record<CuratedPresetKey, CuratedHighlightRow[]> = {
  "nievern-highlights": [
    { key: "deutsches-eck", name: "Deutsches Eck", lat: 50.3645, lng: 7.6066, category: "landmark", region: "koblenz", country: "Germany", description: "Berühmte Landmarke an der Landzunge am Zusammenfluss von Rhein und Mosel mit Kaiser-Wilhelm-Nationaldenkmal und großem Aussichtspunkt.", tags: ["rivers-confluence", "landmark", "national-monument", "major-viewpoint", "major-attraction"] },
    { key: "festung-ehrenbreitstein", name: "Festung Ehrenbreitstein", lat: 50.369, lng: 7.6136, category: "fortress", region: "koblenz", country: "Germany", description: "Große preußische Hauptfestung über Rhein und Mosel, ikonische Landmarke mit Festungsarchitektur und Panoramablick.", tags: ["fortress", "major-fortress", "landmark", "iconic", "major-attraction", "unesco-context"] },
    ...
    { key: "altstadt-koblenz", name: "Altstadt Koblenz", lat: 50.3609, lng: 7.5933, category: "historic-quarter", region: "koblenz", country: "Germany", description: "Historisches Zentrum von Koblenz mit Altstadt-Gassen, Plätzen und bedeutenden Baudenkmalen als klarer Haupt-Anziehungspunkt.", tags: ["old-town", "historic-center", "historic-quarter", "monument-ensemble", "major-attraction"] },
    { key: "schloss-stolzenfels", name: "Schloss Stolzenfels", lat: 50.3029, lng: 7.5723, category: "castle", region: "koblenz", country: "Germany", description: "Markantes Rhein-Schloss (Palace/Schloss) der Rheinromantik mit Aussichtslage über dem Tal.", tags: ["castle", "schloss", "palace", "landmark", "major-viewpoint"] },
    ...
    { key: "marksburg", name: "Marksburg", lat: 50.2746, lng: 7.6409, category: "castle", region: "braubach", country: "Germany", description: "Ikonische mittelalterliche Höhenburg am Mittelrhein, als nahezu vollständig erhaltene Burganlage ein Hauptziel der Region.", tags: ["castle", "medieval-castle", "iconic-castle", "landmark", "major-attraction"] },
    { key: "abtei-maria-laach", name: "Abtei Maria Laach", lat: 50.4084, lng: 7.2729, category: "abbey", region: "maria-laach", country: "Germany", description: "Bedeutende romanische Benediktinerabtei mit Basilika und Klostertradition am Laacher See.", tags: ["abbey", "monastery", "basilica", "pilgrimage", "major-attraction"] },
    { key: "burg-lahneck", name: "Burg Lahneck", lat: 50.3012, lng: 7.6171, category: "castle", region: "lahnstein", country: "Germany", description: "Mittelalterliche Burganlage oberhalb der Lahnmündung mit markantem Landmarken-Charakter.", tags: ["castle", "medieval-castle", "landmark", "major-viewpoint", "rhine"] },
    ...
    { key: "geysir-andernach", name: "Geysir Andernach", lat: 50.4336, lng: 7.4005, category: "natural-attraction", region: "andernach", country: "Germany", description: "Höchster Kaltwassergeysir der Welt als geothermisches Natur-Highlight und klarer Ausflugsmagnet bei Andernach.", tags: ["geysir", "geyser", "geothermal", "natural-attraction", "major-attraction"] },
    ...
    { key: "burg-eltz", name: "Burg Eltz", lat: 50.2003, lng: 7.3366, category: "castle", region: "wierschem", country: "Germany", description: "International ikonische mittelalterliche Burg (Burg Eltz) im Elzbachtal, eines der bekanntesten Hauptziele der Region.", tags: ["castle", "medieval-castle", "iconic-castle", "landmark", "major-attraction"] },
  ],
};
