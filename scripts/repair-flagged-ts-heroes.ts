...
const FLAGGED_IDS = [
  1583, 1581, 1582, 1579, 1572, 1567, 1569, 1525, 1526, 1560, 1578, 1553, 1577, 1568, 1557, 1562, 1576, 1565,
];

const OUT_DIR = path.resolve(process.cwd(), "data/review/ts-hero-audit-2026-03-17/repair");

const MANUAL_OVERRIDES: Record<number, ManualOverride> = {
  1565: {
    source: "manual",
    url: "https://www.rheinparkcamping.com/fileadmin/_processed_/1/5/csm_header-startseite_3d3f833792.jpg",
    score: 92,
    reason: "Manual hero override from the official Rheinpark Camping header image with exterior river/campsite view.",
  },
  1576: {
    source: "manual",
    url: "https://www.knauscamp.de/fileadmin/_processed_/5/4/csm_koblenz_rhein_mosel_header_01_3d6d56c6f1.jpg",
    score: 90,
    reason: "Manual hero override from the official KNAUS Koblenz/Rhein-Mosel exterior header image.",
  },
  1553: {
    source: "manual",
    url: "https://www.campinginsel-sonnenwerth.de/wp-content/uploads/2018/01/slider1.jpg",
    score: 88,
    reason: "Manual hero override from the official Campinginsel Sonnenwerth site with real aerial island view.",
  },
  1557: {
    source: "manual",
    url: "https://www.campingplatz-neumagen.de/images/slider/slider1.jpg",
    score: 86,
    reason: "Manual hero override from the official Campingplatz Neumagen-Dhron site with campsite exterior image.",
  },
  1562: {
    source: "manual",
    url: "http://www.campingwaldfrieden.de/images/slideshow/slide1.jpg",
    score: 86,
    reason: "Manual hero override from Camping-Waldfrieden official exterior image for alias 'Campingplatz Weingarten'.",
  },
  1577: {
    source: "manual",
    url: "https://www.stiller-winkel.de/wp-content/uploads/2019/08/ferienpark-zum-stillen-winkel-panorama.jpg",
    score: 84,
    reason: "Manual hero override from the official Zum stillen Winkel panorama image.",
  },
  1525: {
    source: "manual",
    url: "https://www.lindelgrund.de/images/camping/Lindelgrund-12-k.jpg",
    score: 85,
    reason: "Manual hero override from the official Lindelgrund camping gallery with a real camping motif.",
  },
};
...
async function fetchBuffer(url: string, googleKey: string): Promise<Buffer> {
  const headers: Record<string, string> = {
    "User-Agent": "camping-portal-ts-hero-repair/1.0",
  };
  ...
  for (const place of places) {
    ...
    await prisma.place.update({
      ...
      data: {
        ...
        heroReason: `TS hero repair 2026-03-17: selected ${chosen.source} candidate. ${chosen.reason}`,
        heroCandidates: {
          deleteMany: {},
          create: [
            ...(manualOverride
