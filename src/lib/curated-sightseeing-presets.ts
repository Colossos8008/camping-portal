...
const CURATED_PRESET_DATA: Record<CuratedPresetKey, CuratedHighlightRow[]> = {
  "nievern-highlights": [
    { key: "deutsches-eck", name: "Deutsches Eck", lat: 50.36586, lng: 7.60530, category: "landmark", region: "koblenz", country: "Germany", description: "Berühmte Landmarke an der Landzunge am Zusammenfluss von Rhein und Mosel mit Kaiser-Wilhelm-Nationaldenkmal und großem Aussichtspunkt.", tags: ["rivers-confluence", "landmark", "national-monument", "major-viewpoint", "major-attraction"] },
    { key: "festung-ehrenbreitstein", name: "Festung Ehrenbreitstein", lat: 50.36470, lng: 7.61395, category: "fortress", region: "koblenz", country: "Germany", description: "Große preußische Hauptfestung über Rhein und Mosel, ikonische Landmarke mit Festungsarchitektur und Panoramablick.", tags: ["fortress", "major-fortress", "landmark", "iconic", "major-attraction", "unesco-context"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Festung_Ehrenbreitstein.jpg" },
    ...
    { key: "altstadt-koblenz", name: "Altstadt Koblenz", lat: 50.35997, lng: 7.59603, category: "historic-quarter", region: "koblenz", country: "Germany", description: "Historisches Zentrum von Koblenz mit Altstadt-Gassen, Plätzen und bedeutenden Baudenkmalen als klarer Haupt-Anziehungspunkt.", tags: ["old-town", "historic-center", "historic-quarter", "monument-ensemble", "major-attraction"] },
    { key: "schloss-stolzenfels", name: "Schloss Stolzenfels", lat: 50.30358, lng: 7.57103, category: "castle", region: "koblenz", country: "Germany", description: "Markantes Rhein-Schloss (Palace/Schloss) der Rheinromantik mit Aussichtslage über dem Tal.", tags: ["castle", "schloss", "palace", "landmark", "major-viewpoint"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Schloss_Stolzenfels.jpg" },
    { key: "kurfuerstliches-schloss-koblenz", name: "Kurfürstliches Schloss Koblenz", lat: 50.35223, lng: 7.59831, category: "palace", region: "koblenz", country: "Germany", description: "Klassizistisches Schloss am Rhein mit bedeutender Stadtbildwirkung.", tags: ["palace", "historic", "rhine"] },
    { key: "marksburg", name: "Marksburg", lat: 50.27429, lng: 7.64050, category: "castle", region: "braubach", country: "Germany", description: "Ikonische mittelalterliche Höhenburg am Mittelrhein, als nahezu vollständig erhaltene Burganlage ein Hauptziel der Region.", tags: ["castle", "medieval-castle", "iconic-castle", "landmark", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Marksburg.jpg" },
    { key: "abtei-maria-laach", name: "Abtei Maria Laach", lat: 50.41614, lng: 7.27207, category: "abbey", region: "maria-laach", country: "Germany", description: "Bedeutende romanische Benediktinerabtei mit Basilika und Klostertradition am Laacher See.", tags: ["abbey", "monastery", "basilica", "pilgrimage", "major-attraction"] },
    { key: "burg-lahneck", name: "Burg Lahneck", lat: 50.31189, lng: 7.61774, category: "castle", region: "lahnstein", country: "Germany", description: "Mittelalterliche Burganlage oberhalb der Lahnmündung mit markantem Landmarken-Charakter.", tags: ["castle", "medieval-castle", "landmark", "major-viewpoint", "rhine"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Burg_Lahneck.jpg" },
    { key: "schloss-sayn", name: "Schloss Sayn", lat: 50.43716, lng: 7.57715, category: "palace", region: "bendorf", country: "Germany", description: "Neugotisches Schloss der Fürsten zu Sayn-Wittgenstein-Sayn.", tags: ["palace", "neo-gothic", "bendorf"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Schloss_Sayn.jpg" },
    ...
    { key: "liebfrauenkirche-koblenz", name: "Liebfrauenkirche Koblenz", lat: 50.35956, lng: 7.59514, category: "church", region: "koblenz", country: "Germany", description: "Prägende Pfarrkirche in der Koblenzer Altstadt mit Zwiebeltürmen.", tags: ["church", "old-town", "landmark"] },
    { key: "florinskirche-koblenz", name: "Florinskirche Koblenz", lat: 50.36066, lng: 7.59617, category: "church", region: "koblenz", country: "Germany", description: "Historische Kirche am Florinsmarkt, Teil des markanten Altstadt-Ensembles.", tags: ["church", "historic-center"] },
    ...
    { key: "historiensaeule-koblenz", name: "Historiensäule Koblenz", lat: 50.35970, lng: 7.59624, category: "monument", region: "koblenz", country: "Germany", description: "Säulendenkmal mit Szenen aus der Koblenzer Stadtgeschichte.", tags: ["monument", "history", "old-town"] },
    { key: "jesuitenplatz", name: "Jesuitenplatz", lat: 50.35996, lng: 7.59614, category: "historic-square", region: "koblenz", country: "Germany", description: "Zentraler historischer Platz in der Altstadt, geprägt durch Rathaus und Jesuitenensemble.", tags: ["square", "historic-center", "old-town"] },
    ...
    { key: "garten-der-schmetterlinge-sayn", name: "Garten der Schmetterlinge Schloss Sayn", lat: 50.43649, lng: 7.57769, category: "park", region: "bendorf", country: "Germany", description: "Bekannte Schmetterlingshalle und Parkanlage im Schlosspark Sayn.", tags: ["park", "family-highlight", "sayn"] },
    ...
    { key: "burg-eltz", name: "Burg Eltz", lat: 50.20540, lng: 7.33656, category: "castle", region: "wierschem", country: "Germany", description: "International ikonische mittelalterliche Burg (Burg Eltz) im Elzbachtal, eines der bekanntesten Hauptziele der Region.", tags: ["castle", "medieval-castle", "iconic-castle", "landmark", "major-attraction"], heroImageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Burg_Eltz.jpg" },
  ],
};
